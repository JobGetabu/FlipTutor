...
public class TutoringSessionSeeder {
    ...
    public static void insert(DBHelper db){
        ...
        calendarStartTime.set(Calendar.MONTH, 10);
        ...
        calendarEndTime.set(Calendar.MONTH, 10);
        ...
        db.tutoringSession.insert(2,1,1,1,"Meeting at CS building", startTime, endTime);
        ...
        startTime = timeFormatter.format(calendarStartTime.getTime());
        endTime = timeFormatter.format(calendarEndTime.getTime());
        db.tutoringSession.insert(1,1,2,1,"Meeting at Nyathi", startTime, endTime);
        calendarStartTime = new GregorianCalendar();
        ...
        startTime = timeFormatter.format(calendarStartTime.getTime());
        endTime = timeFormatter.format(calendarEndTime.getTime());
        db.tutoringSession.insert(3,1,1,1,"Meeting at Nyathi Coffee", startTime, endTime);
        ...
        calendarStartTime.set(Calendar.HOUR_OF_DAY, 11);
        calendarStartTime.set(Calendar.MONTH, 11);
        calendarStartTime.set(Calendar.YEAR, 2019);
        calendarStartTime.set(Calendar.MINUTE, 25);
        ...
        calendarEndTime.set(Calendar.HOUR_OF_DAY, 12);
        calendarEndTime.set(Calendar.MONTH, 11);
        calendarEndTime.set(Calendar.YEAR, 2019);
        calendarEndTime.set(Calendar.MINUTE, 25);
        startTime = timeFormatter.format(calendarStartTime.getTime());
        endTime = timeFormatter.format(calendarEndTime.getTime());
        ...
        db.tutoringSession.insert(1,1,2,1,"Meeting at Kimathi Coffee", startTime, endTime);
    }
}